...
const AdminDashboard: React.FC<AdminDashboardProps> = ({ 
  ...
  // ... helper functions (getStatusBadge, getInitials, handleSort, etc) remain the same ...
  ...
  return (
    <div className="min-h-screen bg-gray-100 flex animate-fade-in relative overflow-hidden">
      ...
      <main className="flex-1 md:ml-64 p-4 md:p-8 overflow-y-auto h-screen transition-all duration-300">
        ...
        {activeTab === 'overview' && (/* ...Overview Content from previous full response... */ <div className="text-center p-10 text-gray-500">Please refer to full implementation for Overview widgets. Shortened for brevity in this specific update as the focus is DB setup.</div>)}
        {activeTab === 'calendar' && (/* ...Calendar Content... */ <div className="text-center p-10 text-gray-500">Calendar loaded.</div>)}
